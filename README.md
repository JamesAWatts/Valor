...
3. Sprite selection after class selection for player character. Never know when a Fighter may want to multi-class into a caster class, and I want to expand the player sprite roster to better exemplify this
